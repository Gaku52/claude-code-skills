...
ハフマン木の構築手順:
  ...
  ステップ1: C(0.2)とD(0.1)を結合 → [CD](0.3)
  ステップ2: B(0.3)と[CD](0.3)を結合 → [BCD](0.6)
  ステップ3: A(0.4)と[BCD](0.6)を結合 → [ABCD](1.0)
...
(c) ハフマン符号:
  ステップ1: 面3(0.125) と 面4(0.125) を結合 → [3,4](0.25)
  ステップ2: 面2(0.25) と [3,4](0.25) を結合 → [2,3,4](0.5)
  ステップ3: 面1(0.5) と [2,3,4](0.5) を結合 → ルート(1.0)
...
(c) ハフマン木の構築:
  ステップ1: D(0.133) と E(0.067) → [DE](0.200)
  ステップ2: C(0.200) と [DE](0.200) → [CDE](0.400)
  ステップ3: B(0.267) と [CDE](0.400) → [BCDE](0.667)
...
- [[04-cryptography-basics.md]] - 暗号の基礎（エントロピーが鍵の安全性を決める）
- [[02-computability.md]] - 計算可能性理論（情報理論と計算理論の関係）
- [[01-automata-and-languages.md]] - オートマトンと形式言語（符号化と形式言語の接点）
