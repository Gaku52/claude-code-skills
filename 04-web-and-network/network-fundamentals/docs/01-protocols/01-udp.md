...
**必須**
- [[./00-tcp.md]] — TCP: UDPと対比して理解することで、両者の設計思想の違いが明確になる
- [[../00-introduction/01-osi-and-tcpip-model.md]] — OSI参照モデルとTCP/IPモデルの基礎（トランスポート層の役割）

**推奨**
- [[../00-introduction/02-ip-addressing.md]] — IPアドレスとルーティングの基礎
