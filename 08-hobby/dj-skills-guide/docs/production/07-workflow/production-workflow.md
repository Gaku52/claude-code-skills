...
アイデアから完成までの7つのフェーズを完全マスター。効率的な制作フローで完成率80%を実現します。
...
- 基本的なプログラミングの知識
- 関連する基礎概念の理解
- [Finishing Tracks（楽曲完成技術）](./finishing-tracks.md) の内容を理解していること

---

## なぜProduction Workflowが重要なのか
...
Phase 2: Drums & Bass（ドラムとベース）
時間: 2-3時間
目的: リズムとベースライン
完成物: グルーヴ確立

Phase 3: Harmony（ハーモニー）
時間: 2-3時間
目的: コード・Pad
完成物: ハーモニー完成

Phase 4: Melody（メロディー）
時間: 2-3時間
目的: Lead・Vocal
完成物: 全要素完成

Phase 5: Arrangement（アレンジメント）
時間: 3-5時間
目的: 曲構造・展開
完成物: 完全な楽曲

Phase 6: Mixing（ミキシング）
時間: 3-5時間
目的: バランス・空間
完成物: ミックス完成

Phase 7: Mastering（マスタリング）
時間: 1-2時間
目的: 最終調整・ラウドネス
完成物: リリース可能
...
Step 2: Session → Arrangement（30分）
...
### 手順（詳細は04-effects/mastering-chain.md参照）
...
Phase 5: Arrangement（3-5時間）
□ 完全な楽曲構造
□ Intro・Outro 32小節
□ Buildup・Drop完璧
□ エネルギーカーブ理想的

Phase 6: Mixing（3-5時間）
□ Volume Balance完璧
□ Frequency Balance均等
□ Stereo Imaging最適
□ Reference同等
...
- [Project Management（プロジェクト管理）](./project-management.md) - 次のトピックへ進む
