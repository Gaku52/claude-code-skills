...
![Characters](https://img.shields.io/badge/Characters-39892K-informational)
<!-- PROGRESS_BADGES_END -->

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

ソフトウェア開発の全領域をカバーする体系的な知識ベース。
CS基礎からAI活用まで、36 Skills / 877ガイドファイル / 約4,100万字。

> **Status:** Phase 1 進行中 — 全ガイド40KB+化 **747/877（85.1%）完了**
